/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.26';  // PWABuilder fixes — manifest.webmanifest comprehensively rebuilt to unlock 'Package For Stores' button: (a) added id field '/?source=pwa' for stable PWA identity even if URL changes, (b) all icon srcs now absolute URLs (https://dukanlist.com/...) so PWABuilder can resolve them reliably, (c) added 3 maskable purpose icons (96/192/512), 3 any purpose icons (96/192/512), generated icon-maskable-96.png + icon-maskable-192.png via PIL downscale from existing 512 maskable, (d) added 2 screenshots (1280x720 desktop wide + 540x960 mobile narrow) with form_factor + label, (e) updated 4 shortcuts (Browse / Search / List Business / Discover) with proper descriptions + type:'image/png', (f) added launch_handler (navigate-existing,auto), handle_links:'preferred', edge_side_panel for desktop, display_override fallback chain, lang:'en-IN'. Inclusive name: 'Local Businesses, Services & Professionals'. Bumped SW so manifest updates propagate immediately.
