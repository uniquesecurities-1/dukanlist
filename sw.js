/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.38';  // QR POSTER LAYOUT FIX — user reported dead space at bottom + overflow risk if shop name gets longer. Rewrote ALL 5 templates with proper zone-based auto-layout: (a) HEADER region at top: verified pill + shop name (measured to determine 1 or 2 lines via canvas.measureText, dynamic positioning) + category line. (b) FOOTER region anchored to bottom: branding banner + trust lines (established year, custom message, scan instruction) stacked BOTTOM-UP using nextLineY decrementing pattern, so missing optional lines don't leave gaps. (c) MIDDLE region: QR fills remaining space between header end and bottom content top, auto-sized 400-820px, vertically centered. Result: no dead space, long shop names handled gracefully, QR is always as big as possible given content. Applied consistently to Saffron Classic, Premium Dark, Cream Minimal, Festival, B&W templates.
