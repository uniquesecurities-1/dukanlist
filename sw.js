/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.52';  // NUDGE MESSAGE UPGRADE — user feedback: WhatsApp nudge message to incomplete shops looked plain/old. Redesigned with: (a) Modern visual hierarchy — divider lines (━━━), section blocks with title and description on separate lines (instead of cramped single-line bullets), proper spacing. (b) Inclusive language — 'your shop' → 'your business' throughout. (c) Better hierarchy — each issue is now a 2-line block: bold title + description. Issues like '*Photos*' and '*Business Hours*' are clearly readable. (d) Quick Links section visually separated. (e) Sign-off updated to '🛡️ DukanList Team / Powered by DigiMutual Goals Pvt. Ltd.' for branding. Also fixed api/share.js OG metadata: 'Every Shop, One Identity' → 'Every Local Name, One Identity', description updated to include 'doctors, clinics, offices, shops, services, professionals' for inclusive reach.
