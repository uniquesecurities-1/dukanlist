/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.35';  // NEW FEATURE — Free Printable QR Poster (panel/qr-poster.html). Owners can generate beautiful printable QR posters with their shop QR code that customers scan to view the verified DukanList profile. (a) 5 templates: Saffron Classic / Premium Dark / Cream Minimal / Festival / Print B&W. (b) 3 sizes: A4 (window display 1240x1754 @ 150dpi), A5 (counter card 1240x876), Square (1080x1080 for WhatsApp Status). (c) Custom message overlay (60 chars). (d) Auto-includes verified badge if verified_score >= 1, shop name, category icon, city, rating, QR with H-level error correction for print durability. (e) Output: PNG download, PDF download (jsPDF), WhatsApp share via Web Share API, direct browser print. (f) Beautiful gradient backgrounds, shadow effects, gold accents on dark theme, festive multi-color on festival. (g) Tips section: laminate, eye-level placement, A5 for counter. (h) Links added to qr-code.html and dashboard navigation. Tier 1 ROI 3.0 from STRATEGIC_SUGGESTIONS.md — every printed poster = passive marketing in tier-2/3 cities.
