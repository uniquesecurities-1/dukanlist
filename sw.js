/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.37';  // EVERGREEN POSTER — owner pain point: 'agar mere review count 14 se 140 ho jaye to dobara print nikalna padega'. Removed all DYNAMIC numbers (rating_avg, rating_count) from posters because they change frequently and force reprints. Replaced with TIMELESS trust signals that never change: (a) established_year — 'Trusted Since 2009 · 17+ years in business' computed from year (stable), (b) verified badge (stable once verified), (c) shop name (stable), (d) category + city (stable), (e) custom owner message (owner-controlled, doesn't auto-change). Added to all 4 color templates: Saffron Classic shows 'Trusted Since 2009 · 17+ years', Dark shows 'Trusted Since 2009' in gold, Cream shows it subtle in saffron. Updated tips list with prominent 'Evergreen design — print once, lasts forever' highlight in red callout box.
