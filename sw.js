/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.29';  // Phase 1 — Play Store Critical Compliance: (1) ACCOUNT DELETION UI in panel/profile.html — red Danger Zone section at bottom with 2-step confirmation modal. Type 'DELETE' to enable confirm button. Tries request_account_deletion RPC, falls back to status='deletion_requested' update + auth sign-out. 30-day grace period. (2) PRIVACY POLICY rewritten — added detailed third-party services section (Supabase Singapore, Vercel USA, Google Play Services, Cloudflare Turnstile, Groq AI, Google Input Tools each with privacy URL), expanded Section 5 with In-App Account Deletion 7-step process, retention list, Mobile App Permissions section (Section 4.5) declaring NO camera/mic/location/contacts requested + opt-in push notification details + zero telemetry. Section 8 Children's Privacy strengthened to COPPA + GDPR Article 8 compliance with 7-day deletion timeline. TOC updated. Word count 1170 → ~2000. (3) REPORT BUTTONS — Reviews on business.html now have 🚩 Report button bottom-right of each card. reportReview() tries flag_review_public / report_review / flag_review RPCs + review_flags table fallback. Pucho Bhai already had report buttons on questions (line 1435) and replies (line 1464) — no change needed. All UGC content now has user-facing report mechanism for Play Store UGC policy compliance.
