/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.39';  // PRINT ECONOMICS — user's brilliant practical concerns about real-world printing costs for Indian shopkeepers. 3 fixes: (1) NEW '✂️ A4 — 2 Posters/Page (50% saving)' size option, now the DEFAULT. Renders two identical posters stacked vertically on one A4 with dashed cut line + scissor icon labeled 'cut here / यहाँ काटें'. Half the paper cost, half the ink, owner gets 2 posters from 1 print — counter + door display from same page. (2) Saffron template REDESIGNED to be ink-saving: white background with thin saffron accent strips at top (36px) and bottom (28px) only, replacing the previous full saffron gradient border that wasted 60-70% ink. Saves owners ~₹15-25 per inkjet print. (3) SAFE_MARGIN of 60px (10mm at 150dpi) added inside all templates — if printer misaligns by ~5mm, content stays intact. PDF generation handles a4-2up by rendering to A4 paper size. Tips section updated with green '2-up mode' callout + ink-saving messaging.
