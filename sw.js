/* ============================================================
   ...
   ============================================================ */
const VERSION    = 'dukan-v2.9.32';  // INCLUSIVE LANGUAGE COMPLETE — additional sweep cleaned: index.html hero category strip 'Doctor · CA · Mechanic · School · NGO · Shop · Clinic · Office' (already mentioned variety but added Hospital · Showroom), Agri Shops → Agri Listings, TikTok-Style Shops → TikTok-Style Discovery, Shop of the Week → Listing of the Week, Public Q&A on Shop Pages → on Listing Pages, TOP 5 SHOPS → TOP 5 LISTINGS, Tag Any Shop → Tag Any Business. business.html meta title 'Every Shop, One Identity' → 'Every Business, One Identity'. Code identifiers (.shop-highlights CSS class, ShopDB, shop_* vars, URL slugs like /tyre-shop) intentionally preserved — they're code/internal not user-facing.
