  ...
  async function render(){
    ...
    try {
      ...
      var r = await c.from('businesses')
        .select('id,slug,name,name_hi,owner_name,mobile,whatsapp,address_line1,address_line2,city_id,category_id,is_professional_listing,professional_tier,geo_cities(name)')
        .eq('status', 'active')
